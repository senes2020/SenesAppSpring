...
import com.senes.senesapp.tools.pagamento.exception.CartaoInvalidoException;
import com.senes.senesapp.tools.pagamento.repository.CartaoRepository;
...
public class CartaoServiceImpl implements CartaoService{
	...
	public boolean validarCartao(CartaoCredito cartaoCredito) {
		...
		if (!validarDataValidade(cartaoCredito.getData_validade())) {
			throw new CartaoInvalidoException(cartaoCredito);
		}
